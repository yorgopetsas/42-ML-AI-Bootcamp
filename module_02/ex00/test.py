...
# squared_numbers = ft_map(square, iterable)
# # even_numbers = ft_filter(is_even, iterable)
# # reduced_numbers = ft_reduce(add, iterable)

# # # PRINTS
# # print(list(reduced_numbers))
# # print(list(even_numbers))
# # print(squared_numbers)
# # Not Working
# print(ft_map(square, iterable))
# # print(list(ft_map(square, iterable)))